import { fluxDateTime, fluxDuration, fluxInteger, FluxParameterLike } from '@influxdata/influxdb-client';
import { FluxDurationString } from '../types/base';
import { QueryFragment } from './queryFragment';

export class RangeFragment extends QueryFragment {
  protected functionName = 'range';
  constructor(
    protected start: bigint | Date | FluxDurationString,
    protected stop?: bigint | Date | FluxDurationString
  ) {
    super();
  }
