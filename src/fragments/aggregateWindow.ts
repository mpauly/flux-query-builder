...
export class AggregateWindowFragment extends QueryFragment {
    ...
    constructor(protected every: FluxDurationString, protected fn: FluxFunctionName | FluxFunction<any, any>, protected optionalArgs:
        { column?: FluxTableColumn, timeSrc?: FluxTableColumn, timeDst?: FluxTableColumn, createEmpty?: boolean, offset?: FluxDurationString }) {
        super()
    }
    protected collectArgs(): [string, FluxParameterLike | undefined][] {
        return [
            ...
            ['createEmpty', (this.optionalArgs.createEmpty === undefined) ? undefined : fluxBool(this.optionalArgs.createEmpty)],
        ]
    }
}